        ...
        <div className='mx-auto py-8 w-[80%] text-black dark:text-white mb-[500px]'>
            {subscriptionPlan && (
                <div>
                    ...
                    <div className='mt-5'>After subscribing, chat with:  <a href={process.env.NEXT_PUBLIC_BOT_TELEGRAM_LINK} className="text-blue-600">CryptoHints Bot</a>. Run command <span className='font-bold'>`/start`</span> to receive signals</div>
                </div>
            )}
