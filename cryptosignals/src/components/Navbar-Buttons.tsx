...
export default function NavbarButtons() {
    ...
    return (
        <div className="flex flex-row gap-5 md:w-1/4 justify-between md:justify-between">
            ...
            <a className={`font-medium my-auto md:py-6 ${isBotPage ? 'text-primary hover:text-gray-400' : 'text-gray-500 hover:text-gray-400 dark:text-neutral-400 dark:hover:text-neutral-500'}`} href="/bot" aria-current="page">Bot</a>
